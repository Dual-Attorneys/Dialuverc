...
namespace DualAttorneys.Dialuverc.Editor.Deductions
{
    public class DeductionsEditorState
    {
        ...
        public readonly DeductionsEditorArea.Mode Mode;

        public readonly Guid? DeductionSelection;

        public DeductionsEditorState(ImmutableList<EditorDeduction> deductions, EditorDeduction addBuilder, EditorDeduction? editBuilder, DeductionsEditorArea.Mode mode, Guid? deductionSelection)
        {
